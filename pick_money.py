...
background_img = pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "blood.png")).convert(), (500, 600))
player_img = pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "player.png")).convert(), (80, 100))
life_img = pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "life.png")).convert(), (25, 25))
...
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "virus1.png")).convert(), (58, 58)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "virus2.png")).convert(), (75, 75)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "virus3.png")).convert(), (80, 80)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "virus4.png")).convert(), (50, 50)))

money_imgs = []
money_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "bigmoney.png")).convert(), (40, 40)))
money_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "midmoney.png")).convert(), (30, 30)))
money_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("pick_money_folder/img", "smallmoney.png")).convert(), (20, 20)))
...
for i in range(9):
    expl_img = pygame.image.load(os.path.join(
        "pick_money_folder/img", f"expl{i}.png")).convert()
    expl_img.set_colorkey(BLACK)
    expl_anim['lg'].append(pygame.transform.scale(expl_img, (75, 75)))
    expl_anim['sm'].append(pygame.transform.scale(expl_img, (30, 30)))
    player_expl_img = pygame.image.load(
        os.path.join("pick_money_folder/img", f"player_expl{i}.png")).convert()
    player_expl_img.set_colorkey(BLACK)
    expl_anim['player'].append(player_expl_img)

# 載入音樂、音效
die_sound = pygame.mixer.Sound(os.path.join(
    "pick_money_folder/sound", "rumble.ogg"))
expl_sounds = [
    pygame.mixer.Sound(os.path.join("pick_money_folder/sound", "expl0.wav")),
    pygame.mixer.Sound(os.path.join("pick_money_folder/sound", "expl1.wav"))
]
pygame.mixer.music.load(os.path.join(
    "pick_money_folder/sound", "pick_money_background.wav"))
pygame.mixer.music.set_volume(0.7)

font_name = os.path.join("pick_money_folder/font.ttf")
...
def draw_init():
    ...
    draw_text(screen, '上下左右移動人物 蒐集3000金幣即可過關~', 22, WIDTH / 2, HEIGHT / 2)
