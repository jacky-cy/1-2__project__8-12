...
background_img = pygame.transform.scale(pygame.image.load(
    os.path.join("img", "blood.png")).convert(), (500, 600))
player_img = pygame.transform.scale(pygame.image.load(
    os.path.join("img", "pcr.png")).convert(), (60, 60))
player_mini_img = pygame.transform.scale(player_img, (25, 25))
virus_img = pygame.transform.scale(pygame.image.load(
    os.path.join("img", "hp.png")).convert(), (25, 25))
life_img = pygame.transform.scale(pygame.image.load(
    os.path.join("img", "life.png")).convert(), (25, 25))
life_img.set_colorkey(BLACK)
pygame.display.set_icon(virus_img)
bullet_img = pygame.image.load(os.path.join(
    "img", "bullet.png")).convert()
# 載入病毒圖片，並改變大小
virus_imgs = []
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("img", "hp_gray.png")).convert(), (28, 28)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("img", "hp.png")).convert(), (43, 43)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("img", "hp_gray.png")).convert(), (58, 58)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("img", "hp.png")).convert(), (73, 73)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("img", "hp_gray.png")).convert(), (88, 88)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("img", "hp.png")).convert(), (103, 103)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("img", "hp_gray.png")).convert(), (118, 118)))
virus_imgs.append(pygame.transform.scale(pygame.image.load(
    os.path.join("img", "hp.png")).convert(), (133, 133)))
...
power_imgs['gun'] = pygame.image.load(
    os.path.join("img", "gun.png")).convert()
power_imgs['alcohol'] = pygame.transform.scale(pygame.image.load(
    os.path.join("img", "alcohol.png")).convert(), (15, 35))
...
def draw_init():
    ...
    draw_text(screen, '擊敗病毒獲取三罐酒精即可過關！', 22, WIDTH / 2, HEIGHT * 2 / 5)
...
class Siblings(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
...
class Bullet_sibling(pygame.sprite.Sprite):
    def __init__(self, x, y):
        pygame.sprite.Sprite.__init__(self)
        self.image = bullet_img
        self.image.set_colorkey(BLACK)
        ...
        self.rect.centerx = self.sibling.get_sibling_pos()
        self.rect.bottom = y
        self.speedy = -10
...
class Power(pygame.sprite.Sprite):
    def __init__(self, center):
        pygame.sprite.Sprite.__init__(self)
        self.type = random.choice(['shield', 'gun', 'alcohol'])
